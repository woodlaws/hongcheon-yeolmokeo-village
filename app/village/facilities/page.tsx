...
import { ArrowRight, Building2, CircleHelp, ExternalLink, MapPin, Phone, Utensils, Waves } from "lucide-react";
  ...
  return <><SiteHeader /><main className="facilities-page">
    <section className="facilities-hero">
      <div className="container facilities-hero-grid">
        <div className="facilities-hero-copy"><p className="section-kicker">VILLAGE FACILITIES</p><h1>열목어마을<br />시설 안내</h1><p>방문 전, 머무르고 함께하는 공간을 살펴보세요.</p><span>방문 목적과 희망 일정을 알려주시면 이용 가능한 공간과 세부 운영 방식을 안내합니다.</span></div>
