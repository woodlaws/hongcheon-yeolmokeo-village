...
export const stayRooms: StayRoom[] = [
  ...
  },
  {
    ...
    amenities: [
      ...
      { name: "성별 분리·침구 구성", state: "needsConfirmation", note: "단체 구성 상담 시 안내" },
    ],
    images: [],
    verified: true,
    currentlyAvailable: null,
    needsConfirmation: true,
    bookingUrl: null,
    workAccess: "비움센터 연계 · 이용 조건은 상담 안내",
    programAccess: "가까움",
  },
  {
    id: "hanok",
  ...
  },
  {
    ...
    inventoryNote: "워케이션 객실은 선택한 날짜와 인원에 따라 배정됩니다.",
  },
];

export const stayModes = [
  { id: "stay-only", title: "숙소만 이용", text: "자연 속에서 조용히 쉬고 싶은 개인과 가족", note: "일반 객실은 네이버 예약에서 날짜와 상품 선택", query: "stay-only" },
  { id: "stay-package", title: "숙박＋치유 프로그램", text: "숲길 걷기, 족욕, 명상, 치유밥상을 함께 경험", note: "구성은 계절과 일정에 따라 달라집니다.", query: "stay-package" },
  { id: "healing-trip", title: "1박 2일 치유여행", text: "숙박, 식사, 프로그램이 결합된 체류형 여행", note: "희망 일정과 인원을 상담 페이지에 남겨주세요", query: "stay-package" },
  { id: "workation", title: "2박 3일 워케이션", text: "숙박, 업무공간, 식사, 치유 프로그램을 결합", note: "희망 일정과 인원을 상담 페이지에 남겨주세요", query: "workation" },
...
export const stayFacilities = [
  ...
  { name: "조망대", verified: true, currentlyAvailable: null, needsConfirmation: true, includedWithStay: null, usageNotes: "워케이션 안내 자료에 소개된 공간 · 이용은 상담 안내" },
...
export const stayFaqs = [
  ["숙소만 예약할 수 있나요?", "일반 객실의 실시간 예약 가능 일정, 이용금액과 결제는 네이버 예약에서 확인해 주세요."],
  ["치유 프로그램과 숙박을 함께 이용할 수 있나요?", "기존 자료에서 숙박·식사·프로그램 결합 상품이 확인됩니다. 현재 구성과 일정은 계절 및 인원에 따라 상담해 드립니다."],
  ["객실별 최대 인원은 몇 명인가요?", "객실 표기는 보금자리 2인 또는 2~3인, 비움센터 2인실·3인실, 한옥 2인실 1동·3인실 1동입니다. 단체 전체 인원은 희망 날짜와 함께 문의해 주세요."],
  ["객실 안에 화장실과 샤워실이 있나요?", "보금자리와 한옥 숙소는 객실 내 단독 화장실·샤워실, 비움센터는 센터 내 공용 화장실·샤워실로 안내되어 있습니다. 워케이션은 배정 객실의 설비를 상담 시 안내합니다."],
  ...
  ["주차가 가능한가요?", "차량 종류와 대수를 문의할 때 알려주시면 주차 위치와 진입 동선을 안내합니다."],
