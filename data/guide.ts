...
export const guideItineraries = [
  ...
  },
  {
    ...
    notice: "업무공간, 숙박, 식사와 프로그램의 현재 운영 조건은 날짜와 인원에 따라 확인합니다.", primary: "/contact?type=workation&duration=workation", primaryLabel: "2박 3일 워케이션 보기", secondary: "/contact?type=stay&stayMode=workation", secondaryLabel: "숙박 가능 여부 문의",
  },
] as const;
...
export const guideFaqs = [
  ...
  ["숙소와 프로그램은 따로 예약해야 하나요?", "숙박·식사·프로그램을 함께 상담할 수 있습니다. 실제 가능 여부와 결제 방식은 일정 확정 과정에서 안내받으세요."],
