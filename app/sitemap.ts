...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/village", "/village/greeting", "/village/vision", "/village/yeolmokeo", "/village/facilities", "/village/location", "/programs", "/stay", "/group", "/guide", "/travel", "/travel/ginkgo-forest", "/market", "/stories", "/contact", "/privacy", "/terms"];
