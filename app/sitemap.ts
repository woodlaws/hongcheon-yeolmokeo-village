...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/village", "/village/greeting", "/village/vision", "/village/yeolmokeo", "/village/location", "/programs", "/stay", "/group", "/guide", "/travel", "/market", "/stories", "/contact", "/privacy", "/terms"];
