...
export const groupElements = [
  ...
  { title: "관계", items: ["팀 대화", "공동 체험", "네트워킹", "조직 맞춤 워크숍"], proposed: true, note: "퍼실리테이터가 필요하면 견적 요청에 적어주세요." },
...
export const groupSummary = [
  ["대상 기관", "기업·공공기관·학교·소방·복지·협회"], ["당일·숙박", "모두 구성 가능 · 희망 일정 상담"], ["추천 기간", "당일·1박 2일·2박 3일"], ["주요 프로그램", "숲·몸·마음·농촌·소통 활동"], ["숙소", "보금자리·비움센터·한옥·워케이션 객실"], ["식사", "지역 농산물 치유밥상 · 횟수와 메뉴 협의"], ["회의·교육 공간", "장비와 수용 인원은 견적 상담에서 안내"], ["맞춤 구성", "기관 목적·대상·계절에 따라 협의"], ["비용", "인원과 구성에 따라 상담 후 안내"], ["예약 방식", "온라인 견적 문의 후 일정 안내"],
] as const;

export const groupFaqs = [
  ["최소 또는 최대 참여 인원은 몇 명인가요?", "예상 인원과 기관 유형을 견적 요청에 적어주시면 숙소와 공간에 맞는 참여 범위를 안내합니다."],
  ...
  ["버스 진입과 주차가 가능한가요?", "차량 종류와 대수를 견적 요청에 적어주시면 진입과 주차 동선을 안내합니다."],
  ...
  ["예약은 언제까지 해야 하나요?", "희망일과 대체일을 함께 보내주시면 가능한 일정을 먼저 안내합니다."],
