...
const typeMap: Record<string,string> = { trip:"여행 일정 상담", stay:"숙박 문의", "stay-only":"숙박 문의", "stay-package":"숙박 패키지 문의", workation:"워케이션 문의", group:"단체 견적 문의", "group-stay":"단체 숙박 견적 문의" };
...
export function ContactForm(){
  ...
  return <form className="contact-form" onSubmit={submit}>
    <label><span>문의 유형 *</span><select name="type" defaultValue={initialType} required><option>여행 일정 상담</option><option>숙박 문의</option><option>숙박 패키지 문의</option><option>워케이션 문의</option><option>프로그램 문의</option><option>단체 견적 문의</option><option>단체 숙박 견적 문의</option><option>상품 구매 문의</option><option>기타 문의</option></select></label>
