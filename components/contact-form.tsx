...
const typeMap: Record<string,string> = { stay:"숙박 문의", group:"단체 견적 문의" };
...
export function ContactForm(){
  ...
  return <form className="contact-form" onSubmit={submit}>
    <label><span>문의 유형 *</span><select name="type" defaultValue={initialType} required><option>숙박 문의</option><option>프로그램 문의</option><option>단체 견적 문의</option><option>상품 구매 문의</option><option>기타 문의</option></select></label>
